 ...
 * =============================================================================
 * File: Home.js
 * Deskripsi: Halaman utama website virtualign.id
 * 
 * Sections:
 *  - Hero Section: Banner utama dengan judul dan CTA
 *  - Virtual Tour Section: Penjelasan fitur virtual tour
 *  - Services Section: Layanan yang ditawarkan
 *  - Advantages Section: Keunggulan platform
 * 
 * Features:
 *  - CMS Integration: Content dari database
 *  - Theme Support: Warna dari CMS theme
...
/**
 * Default content jika CMS belum tersedia
 * Digunakan sebagai fallback saat data masih loading
 */
...
/**
 * Loading spinner yang ditampilkan saat mengambil data dari CMS
 */
...
/**
 * Hero Section - Banner utama dengan judul, subtitle, dan preview cards
 * 
 * @param {Object} content - Content dari CMS
 */
    ...
    <div className="hero-container">
      ...
      >
        <h1 className="hero-title">
          {content.hero?.title || 'Buat Virtual Tour yang Membanggakan Anda'}
        </h1>
        <p className="hero-subtitle">
          {content.hero?.subtitle || 'Luncurkan platform vitual tour kustomisasi Anda tanpa hambatan. Tampilkan pengalaman 3D dan ruang interaktif yang unik, fitur lengkap, responsif di semua perangkat.'}
        </p>
        <motion.button 
...
function Home() {
  ...
  return (
    <div className="home-page" style={{ background: theme?.homeBgColor || '#000000' }}>
