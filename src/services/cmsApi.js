...
deleteQuestion: async (id) => {
  ...
  // HOUSE TYPES
  // =========================
  getHouseTypes: async (includeInactive = false) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types?include_inactive=${includeInactive}`);
      const data = await response.json();
      return data;
    } catch (error) {
  ...
  getHouseTypeById: async (houseId) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types/${houseId}`);
      const data = await response.json();
      return data;
    } catch (error) {
      console.error('Get house type error:', error);
      return { status: 'error', message: error.message };
    }
  },

  getHouseTypesByCategory: async (category) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types/category/${category}`);
      const data = await response.json();
      return data;
    } catch (error) {
      console.error('Get house types by category error:', error);
      return { status: 'error', message: error.message };
    }
  },

  createHouseType: async (houseData) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  updateHouseType: async (houseId, houseData) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types/${houseId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  toggleHouseTypeActive: async (houseId) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types/${houseId}/toggle-active`, {
        method: 'PUT',
      });
      const data = await response.json();
      return data;
    } catch (error) {
      console.error('Toggle house type active error:', error);
      return { status: 'error', message: error.message };
    }
  },

  reorderHouseType: async (houseId, displayOrder) => {
    try {
      const response = await fetch(`${API_BASE_URL}/house-types/${houseId}/reorder`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
      ...
      console.error('Reorder house type error:', error);
      return { status: 'error', message: error.message };
    }
  },
};
